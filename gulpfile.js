...
var jsSource = ["src/vendor/**/jquery.js", "src/vendor/**/bootstrap.js"];
...
// Copy the Bower dependancies to the src/vendor folder
// from there they can be concatenated into the main js
// file for the development build
gulp.task("vendor", function() {
  return gulp
    .src(mainBowerFiles(/* options */), { base: "bower_components/" })
...
gulp.task("jsuglify", function() {
  gulp
    .src("builds/development/js/main.js")
    .pipe(uglify())
